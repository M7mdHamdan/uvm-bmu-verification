...
# history.py generated at 2025/09/06 15:46:11
# host: orionvtech
# port: 46443
# launch command: indago -connect dc:orionvtech.orionvtech.com:57053 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=46443,
        extra_args='-connect dc:orionvtech.orionvtech.com:57053 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 46443
# Verisium: **************************************************************************************
